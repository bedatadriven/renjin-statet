...
public class R$primitive$$minus
    extends BuiltinFunction
{


    public R$primitive$$minus() {
        super("-");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$$minus.doApply(context, environment, call, argNames, args);
    }

    public static SEXP doApply(Context context, Environment environment, SEXP arg0)
        throws Exception
    {
        if ((arg0 .length() == 0)||(arg0 instanceof IntVector)) {
            ...
            if ((cycles > 100)||(vector0 instanceof DeferredComputation)) {
                return new R$primitive$$minus$deferred_i(vector0, vector0 .getAttributes());
            }
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)) {
                    ...
                    builder.set(i, Ops.minus(vector0 .getElementAsInt(currentElementIndex0)));
                }
            ...
            if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
                ...
                if ((cycles > 100)||(vector0 instanceof DeferredComputation)) {
                    return new R$primitive$$minus$deferred_d(vector0, vector0 .getAttributes());
                }
                ...
                for (int i = 0; (i!= cycles); i ++) {
                    if (vector0 .isElementNA(currentElementIndex0)) {
                        ...
                        builder.set(i, Ops.minus(vector0 .getElementAsDouble(currentElementIndex0)));
                    }
                    currentElementIndex0 += 1;
                    if (currentElementIndex0 == length0) {
                        currentElementIndex0 = 0;
                ...
                throw new EvalException(String.format("Invalid argument:\n\t-(%s)\n\tExpected:\n\t-(integer)\n\t-(double, double)\n\t-(double)\n\t-(Complex, Complex)", arg0 .getTypeName()));
            }
        }
    }
        ...
        throws Exception
    {
        if (((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0))))&&((arg1 .length() == 0)||((arg1 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg1))))) {
            ...
            if (((cycles > 100)||(vector0 instanceof DeferredComputation))||(vector1 instanceof DeferredComputation)) {
                return new R$primitive$$minus$deferred_dd(vector0, vector1, AttributeMap.combineAttributes(vector0, vector1));
            }
            org.renjin.sexp.DoubleArrayVector.Builder builder = new org.renjin.sexp.DoubleArrayVector.Builder(cycles);
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)||vector1 .isElementNA(currentElementIndex1)) {
                    ...
                    builder.set(i, Ops.minus(vector0 .getElementAsDouble(currentElementIndex0), vector1 .getElementAsDouble(currentElementIndex1)));
                }
                currentElementIndex0 += 1;
                if (currentElementIndex0 == length0) {
                    currentElementIndex0 = 0;
            ...
            if (((arg0 .length() == 0)||((arg0 instanceof Vector)&&ComplexVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0))))&&((arg1 .length() == 0)||((arg1 instanceof Vector)&&ComplexVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg1))))) {
                ...
                for (int i = 0; (i!= cycles); i ++) {
                    if (vector0 .isElementNA(currentElementIndex0)||vector1 .isElementNA(currentElementIndex1)) {
                        ...
                        builder.set(i, Ops.minus(vector0 .getElementAsComplex(currentElementIndex0), vector1 .getElementAsComplex(currentElementIndex1)));
                    }
                    currentElementIndex0 += 1;
                    if (currentElementIndex0 == length0) {
                        currentElementIndex0 = 0;
