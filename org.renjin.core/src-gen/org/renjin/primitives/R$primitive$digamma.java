...
public class R$primitive$digamma
    extends BuiltinFunction
{


    public R$primitive$digamma() {
        super("digamma");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("digamma: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tdigamma(double)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("digamma: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$digamma.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)) {
                    ...
                    builder.set(i, Gamma.digamma(vector0 .getElementAsDouble(currentElementIndex0)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tdigamma(%s)\n\tExpected:\n\tdigamma(double)", arg0 .getTypeName()));
        }
    }
