...
public class R$primitive$expm1
    extends BuiltinFunction
{


    public R$primitive$expm1() {
        super("expm1");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("expm1: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\texpm1(double)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("expm1: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$expm1 .doApply(context, environment, call, argNames, args);
    }
        ...
        throws Exception
    {
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            if ((cycles > 100)||(vector0 instanceof DeferredComputation)) {
                return new R$primitive$expm1$deferred_d(vector0, vector0 .getAttributes().copyStructural());
            }
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)) {
                    ...
                    builder.set(i, MathExt.expm1(vector0 .getElementAsDouble(currentElementIndex0)));
                }
