...
public class R$primitive$ceiling$deferred_d
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$ceiling$deferred_d(Vector arg0, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$ceiling$deferred_d(arg0, attributes);
    }
