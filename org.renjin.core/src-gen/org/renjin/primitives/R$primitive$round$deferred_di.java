...
public class R$primitive$round$deferred_di
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$round$deferred_di(Vector arg0, Vector arg1, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$round$deferred_di(arg0, arg1, attributes);
    }
