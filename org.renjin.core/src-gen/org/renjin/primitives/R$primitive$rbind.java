...
public class R$primitive$rbind
    extends SpecialFunction
{


    public R$primitive$rbind() {
        super("rbind");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            return Combine.rbind(context, environment, pos2, varArgList);
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\trbind(integer(1), ...)", e.getMessage());
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$rbind.doApply(context, environment, call, argNames, args);
    }
