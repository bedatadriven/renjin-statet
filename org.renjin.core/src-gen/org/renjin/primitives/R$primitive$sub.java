...
public class R$primitive$sub
    extends BuiltinFunction
{


    public R$primitive$sub() {
        super("sub");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("sub: too many arguments, expected at most 7.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tsub(character(1), character(1), character, logical(1), logical(1), logical(1), logical(1))", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("sub: max arity is 7");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$sub.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((((((((arg0 instanceof Vector)&&StringVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))&&((arg1 instanceof Vector)&&StringVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg1))))&&((arg2 .length() == 0)||((arg2 instanceof Vector)&&StringVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg2)))))&&(arg3 instanceof Vector))&&(arg4 instanceof Vector))&&(arg5 instanceof Vector))&&(arg6 instanceof Vector)) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector2 .isElementNA(currentElementIndex2)) {
                    ...
                    builder.set(i, Text.sub(WrapperRuntime.convertToString(arg0), WrapperRuntime.convertToString(arg1), vector2 .getElementAsString(currentElementIndex2), WrapperRuntime.convertToBooleanPrimitive(arg3), WrapperRuntime.convertToBooleanPrimitive(arg4), WrapperRuntime.convertToBooleanPrimitive(arg5), WrapperRuntime.convertToBooleanPrimitive(arg6)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tsub(%s, %s, %s, %s, %s, %s, %s)\n\tExpected:\n\tsub(character(1), character(1), character, logical(1), logical(1), logical(1), logical(1))", arg0 .getTypeName(), arg1 .getTypeName(), arg2 .getTypeName(), arg3 .getTypeName(), arg4 .getTypeName(), arg5 .getTypeName(), arg6 .getTypeName()));
        }
    }
