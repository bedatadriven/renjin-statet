...
public class R$primitive$as$POSIXct
    extends BuiltinFunction
{


    public R$primitive$as$POSIXct() {
        super("as.POSIXct");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("as.POSIXct: too many arguments, expected at most 2.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tas.POSIXct(list, character(1))", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("as.POSIXct: max arity is 2");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$as$POSIXct.doApply(context, environment, call, argNames, args);
    }
