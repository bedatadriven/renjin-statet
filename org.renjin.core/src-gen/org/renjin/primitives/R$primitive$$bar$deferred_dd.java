...
public class R$primitive$$bar$deferred_dd
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$$bar$deferred_dd(Vector arg0, Vector arg1, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public int getElementAsRawLogical(int index) {
        ...
        return Ops.or(arg0_i, arg1_i).getInternalValue();
    }
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$$bar$deferred_dd(arg0, arg1, attributes);
    }
    ...
    public static int compute(double p0, double p1) {
        return Ops.or(p0, p1).getInternalValue();
    }
