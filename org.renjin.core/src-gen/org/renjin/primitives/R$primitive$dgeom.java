...
public class R$primitive$dgeom
    extends BuiltinFunction
{


    public R$primitive$dgeom() {
        super("dgeom");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("dgeom: too many arguments, expected at most 3.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tdgeom(double, double, logical(1))", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("dgeom: max arity is 3");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$dgeom.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0))))&&((arg1 .length() == 0)||((arg1 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg1)))))&&(arg2 instanceof Vector)) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)||vector1 .isElementNA(currentElementIndex1)) {
                    ...
                    builder.set(i, Distributions.dgeom(vector0 .getElementAsDouble(currentElementIndex0), vector1 .getElementAsDouble(currentElementIndex1), WrapperRuntime.convertToBooleanPrimitive(arg2)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tdgeom(%s, %s, %s)\n\tExpected:\n\tdgeom(double, double, logical(1))", arg0 .getTypeName(), arg1 .getTypeName(), arg2 .getTypeName()));
        }
    }
