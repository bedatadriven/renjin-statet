...
public class R$primitive$trunc$deferred_d
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$trunc$deferred_d(Vector arg0, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public double getElementAsDouble(int index) {
        ...
        return MathExt.truncate(arg0_i);
    }
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$trunc$deferred_d(arg0, attributes);
    }
