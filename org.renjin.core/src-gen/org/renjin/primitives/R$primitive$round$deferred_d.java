...
public class R$primitive$round$deferred_d
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$round$deferred_d(Vector arg0, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$round$deferred_d(arg0, attributes);
    }
