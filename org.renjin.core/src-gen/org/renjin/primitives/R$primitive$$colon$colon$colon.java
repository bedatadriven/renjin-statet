...
public class R$primitive$$colon$colon$colon
    extends SpecialFunction
{


    public R$primitive$$colon$colon$colon() {
        super(":::");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$$colon$colon$colon.doApply(context, environment, call, argNames, args);
    }
        ...
        throws Exception
    {
        if ((arg0 instanceof Symbol)&&(arg1 instanceof Symbol)) {
            return Namespaces.getNamespaceValue(context.getSingleton(NamespaceRegistry.class), ((Symbol) arg0), ((Symbol) arg1));
        } else {
