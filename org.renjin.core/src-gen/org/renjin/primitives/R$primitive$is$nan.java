...
public class R$primitive$is$nan
    extends BuiltinFunction
{


    public R$primitive$is$nan() {
        super("is.nan");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            if (((AbstractSEXP) s0).isObject()) {
                SEXP genericResult = S3 .tryDispatchFromPrimitive(context, environment, call, "is.nan", s0, args);
            ...
            throw new EvalException("is.nan: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tis.nan(double)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("is.nan: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$is$nan.doApply(context, environment, call, argNames, args);
    }
        ...
        throws Exception
    {
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                builder.set(i, Types.isNaN(vector0 .getElementAsDouble(currentElementIndex0)));
            ...
            throw new EvalException(String.format("Invalid argument:\n\tis.nan(%s)\n\tExpected:\n\tis.nan(double)", arg0 .getTypeName()));
        }
    }
