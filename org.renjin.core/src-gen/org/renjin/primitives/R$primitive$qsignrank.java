...
public class R$primitive$qsignrank
    extends BuiltinFunction
{


    public R$primitive$qsignrank() {
        super("qsignrank");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("qsignrank: too many arguments, expected at most 4.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tqsignrank(double, double, logical, logical)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("qsignrank: max arity is 4");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$qsignrank.doApply(context, environment, call, argNames, args);
    }
        ...
        if (((((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0))))&&((arg1 .length() == 0)||((arg1 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg1)))))&&((arg2 .length() == 0)||(arg2 instanceof Vector)))&&((arg3 .length() == 0)||(arg3 instanceof Vector))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (((vector0 .isElementNA(currentElementIndex0)||vector1 .isElementNA(currentElementIndex1))||vector2 .isElementNA(currentElementIndex2))||vector3 .isElementNA(currentElementIndex3)) {
                    ...
                    builder.set(i, Distributions.qsignrank(vector0 .getElementAsDouble(currentElementIndex0), vector1 .getElementAsDouble(currentElementIndex1), vector2 .isElementTrue(currentElementIndex2), vector3 .isElementTrue(currentElementIndex3)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tqsignrank(%s, %s, %s, %s)\n\tExpected:\n\tqsignrank(double, double, logical, logical)", arg0 .getTypeName(), arg1 .getTypeName(), arg2 .getTypeName(), arg3 .getTypeName()));
        }
    }
