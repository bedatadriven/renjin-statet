...
public class R$primitive$Sys$umask
    extends BuiltinFunction
{


    public R$primitive$Sys$umask() {
        super("Sys.umask");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("Sys.umask: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tSys.umask(integer)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("Sys.umask: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$Sys$umask.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((arg0 .length() == 0)||(((arg0 instanceof IntVector)||(arg0 instanceof DoubleVector))||(arg0 instanceof LogicalVector))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)) {
                    ...
                    builder.set(i, System.sysChmod(vector0 .getElementAsInt(currentElementIndex0)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tSys.umask(%s)\n\tExpected:\n\tSys.umask(integer)", arg0 .getTypeName()));
        }
    }
