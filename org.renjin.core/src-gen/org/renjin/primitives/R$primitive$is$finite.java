...
public class R$primitive$is$finite
    extends BuiltinFunction
{


    public R$primitive$is$finite() {
        super("is.finite");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            if (((AbstractSEXP) s0).isObject()) {
                SEXP genericResult = S3 .tryDispatchFromPrimitive(context, environment, call, "is.finite", s0, args);
            ...
            throw new EvalException("is.finite: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tis.finite(double)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("is.finite: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$is$finite.doApply(context, environment, call, argNames, args);
    }
        ...
        throws Exception
    {
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                builder.set(i, Types.isFinite(vector0 .getElementAsDouble(currentElementIndex0)));
            ...
            throw new EvalException(String.format("Invalid argument:\n\tis.finite(%s)\n\tExpected:\n\tis.finite(double)", arg0 .getTypeName()));
        }
    }
