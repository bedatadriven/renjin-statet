...
public class R$primitive$qwilcox
    extends BuiltinFunction
{


    public R$primitive$qwilcox() {
        super("qwilcox");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("qwilcox: too many arguments, expected at most 5.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tqwilcox(double, double, double, logical, logical)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("qwilcox: max arity is 5");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$qwilcox.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((((((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0))))&&((arg1 .length() == 0)||((arg1 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg1)))))&&((arg2 .length() == 0)||((arg2 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg2)))))&&((arg3 .length() == 0)||(arg3 instanceof Vector)))&&((arg4 .length() == 0)||(arg4 instanceof Vector))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if ((((vector0 .isElementNA(currentElementIndex0)||vector1 .isElementNA(currentElementIndex1))||vector2 .isElementNA(currentElementIndex2))||vector3 .isElementNA(currentElementIndex3))||vector4 .isElementNA(currentElementIndex4)) {
                    ...
                    builder.set(i, Distributions.qwilcox(vector0 .getElementAsDouble(currentElementIndex0), vector1 .getElementAsDouble(currentElementIndex1), vector2 .getElementAsDouble(currentElementIndex2), vector3 .isElementTrue(currentElementIndex3), vector4 .isElementTrue(currentElementIndex4)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tqwilcox(%s, %s, %s, %s, %s)\n\tExpected:\n\tqwilcox(double, double, double, logical, logical)", arg0 .getTypeName(), arg1 .getTypeName(), arg2 .getTypeName(), arg3 .getTypeName(), arg4 .getTypeName()));
        }
    }
