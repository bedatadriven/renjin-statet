...
public class R$primitive$$greater$deferred_dd
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$$greater$deferred_dd(Vector arg0, Vector arg1, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$$greater$deferred_dd(arg0, arg1, attributes);
    }
