...
public class R$primitive$file$exists
    extends BuiltinFunction
{


    public R$primitive$file$exists() {
        super("file.exists");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("file.exists: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tfile.exists(character)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("file.exists: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$file$exists.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&StringVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector1 .isElementNA(currentElementIndex1)) {
                    ...
                    builder.set(i, Files.fileExists(context, vector1 .getElementAsString(currentElementIndex1)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tfile.exists(%s)\n\tExpected:\n\tfile.exists(character)", arg0 .getTypeName()));
        }
    }
