...
public class R$primitive$$colon
    extends BuiltinFunction
{


    public R$primitive$$colon() {
        super(":");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$$colon.doApply(context, environment, call, argNames, args);
    }
        ...
        throws Exception
    {
        if ((arg0 instanceof SEXP)&&(arg1 instanceof SEXP)) {
            return Sequences.colon(context, ((SEXP) arg0), ((SEXP) arg1));
        } else {
            throw new EvalException(String.format("Invalid argument:\n\t:(%s, %s)\n\tExpected:\n\t:(any, any)", arg0 .getTypeName(), arg1 .getTypeName()));
        }
    }
