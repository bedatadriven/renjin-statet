...
public class R$primitive$basename
    extends BuiltinFunction
{


    public R$primitive$basename() {
        super("basename");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("basename: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tbasename(character)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("basename: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$basename.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&StringVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)) {
                    ...
                    builder.set(i, Files.basename(vector0 .getElementAsString(currentElementIndex0)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tbasename(%s)\n\tExpected:\n\tbasename(character)", arg0 .getTypeName()));
        }
    }
