...
public class R$primitive$$subset
    extends BuiltinFunction
{


    public R$primitive$$subset() {
        super(".subset");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            return Subsetting.subset(pos0, varArgList, flag0);
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\t.subset(any, ..., logical(1))", e.getMessage());
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$$subset.doApply(context, environment, call, argNames, args);
    }
