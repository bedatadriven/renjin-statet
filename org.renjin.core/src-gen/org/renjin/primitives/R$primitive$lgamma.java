...
public class R$primitive$lgamma
    extends BuiltinFunction
{


    public R$primitive$lgamma() {
        super("lgamma");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            throw new EvalException("lgamma: too many arguments, expected at most 1.");
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tlgamma(double)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        ...
        throw new EvalException("lgamma: max arity is 1");
    }

    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$lgamma.doApply(context, environment, call, argNames, args);
    }
        ...
        if ((arg0 .length() == 0)||((arg0 instanceof Vector)&&DoubleVector.VECTOR_TYPE.isWiderThanOrEqualTo(((Vector) arg0)))) {
            ...
            for (int i = 0; (i!= cycles); i ++) {
                if (vector0 .isElementNA(currentElementIndex0)) {
                    ...
                    builder.set(i, Gamma.logGamma(vector0 .getElementAsDouble(currentElementIndex0)));
                }
            ...
            throw new EvalException(String.format("Invalid argument:\n\tlgamma(%s)\n\tExpected:\n\tlgamma(double)", arg0 .getTypeName()));
        }
    }
