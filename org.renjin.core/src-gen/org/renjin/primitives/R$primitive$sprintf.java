...
public class R$primitive$sprintf
    extends BuiltinFunction
{


    public R$primitive$sprintf() {
        super("sprintf");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            StringVector pos2;
            pos2 = ((StringVector) argIt.evalNext());
            while (argIt.hasNext()) {
            ...
            return Text.sprintf(context, environment, pos2, varArgList);
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\tsprintf(character, ...)", e.getMessage());
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$sprintf.doApply(context, environment, call, argNames, args);
    }
