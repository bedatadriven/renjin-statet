...
public class R$primitive$order
    extends BuiltinFunction
{


    public R$primitive$order() {
        super("order");
    }
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, PairList args) {
        try {
            ...
            pos1 = WrapperRuntime.convertToBooleanPrimitive(argIt.evalNext());
            while (argIt.hasNext()) {
            ...
            return Sort.order(pos0, pos1, varArgList);
        } catch (ArgumentException e) {
            throw new EvalException(context, "Invalid argument: %s. Expected:\n\torder(logical(1), logical(1), ...)", e.getMessage());
    ...
    public static SEXP doApply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        try {
            ...
            pos1 = WrapperRuntime.convertToBooleanPrimitive(args[ 1 ]);
    ...
    public SEXP apply(Context context, Environment environment, FunctionCall call, String[] argNames, SEXP[] args) {
        return R$primitive$order.doApply(context, environment, call, argNames, args);
    }
