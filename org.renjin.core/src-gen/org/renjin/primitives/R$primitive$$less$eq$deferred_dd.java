...
public class R$primitive$$less$eq$deferred_dd
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$$less$eq$deferred_dd(Vector arg0, Vector arg1, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public int getElementAsRawLogical(int index) {
        ...
        if (Ops.lessThanOrEqualTo(arg0_i, arg1_i)) {
            return  1;
        } else {
            return  0;
        }
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$$less$eq$deferred_dd(arg0, arg1, attributes);
    }
    ...
    public static int compute(double p0, double p1) {
        if (Ops.lessThanOrEqualTo(p0, p1)) {
            return  1;
        } else {
            return  0;
        }
