...
public class R$primitive$$minus$deferred_dd
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$$minus$deferred_dd(Vector arg0, Vector arg1, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public double getElementAsDouble(int index) {
        ...
        return Ops.minus(arg0_i, arg1_i);
    }
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$$minus$deferred_dd(arg0, arg1, attributes);
    }
