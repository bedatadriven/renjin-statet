...
public class R$primitive$$percent$div$percent$deferred_dd
    ...
    implements DeferredComputation
{
    ...
    public R$primitive$$percent$div$percent$deferred_dd(Vector arg0, Vector arg1, AttributeMap attributes) {
        super(attributes);
        length = 0;
        this.arg0 = arg0;
    ...
    public double getElementAsDouble(int index) {
        ...
        return Ops.integerDivision(arg0_i, arg1_i);
    }
    ...
    public SEXP cloneWithNewAttributes(AttributeMap attributes) {
        return new R$primitive$$percent$div$percent$deferred_dd(arg0, arg1, attributes);
    }
    ...
    public static double compute(double p0, double p1) {
        return Ops.integerDivision(p0, p1);
    }
