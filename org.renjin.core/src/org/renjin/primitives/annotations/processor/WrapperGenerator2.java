...
public class WrapperGenerator2 {
	...
	private static final Logger logger = Logger.getLogger(WrapperGenerator2.class.getName());
  ...
  public void compile() throws IOException {
    ...
    Assert.isNotNull(compiler, "JavaCompiler must not be null!");
